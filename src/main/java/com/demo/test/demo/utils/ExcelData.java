...
public class ExcelData {
    ...
    public static void main(String[] args){
        try {
            List<DbModel> maps = redExcel("D:\\169.xlsx");
     ...
     * 建议修改成事件模式
     */
    public static List<DbModel> redExcel(String filePath) throws Exception {
...
//            LinkedHashMap<String, String> map = new LinkedHashMap<>();
            ...
            for (int index = 0; index < row.getPhysicalNumberOfCells(); index++) {
                ...
                if (cell != null){
                    ...
                    if (index == 0){
                        dbModel.setTitle(getString(cell));
                    }
                    if (index == 11){
                        dbModel.setRate(getString(cell));
                    }
                }else {
                    continue;
                }
